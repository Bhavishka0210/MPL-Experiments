...
class QrCodeScreenState extends State<QrCodeScreen> {
  Future<void> scanQR() async {
    ...
    if (!mounted) return;
    final scanQrcode = barcodeScanRes.hashCode.toString();
    context.read<SearchCubit>().searchMealsByQrCode(scanQrcode);
    log(scanQrcode);
  }
          ...
          Positioned(
            ...
            child: BlocListener<SearchCubit, SearchState>(
              ...
              child: Stack(alignment: Alignment.center, children: <Widget>[
                ...
                Positioned(
                    top: AppDimensions.normalize(20), child: const TapToScanTicker()),
              ]),
            ),
          ),
        ],
